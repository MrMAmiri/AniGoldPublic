...
{
    public partial class FactorsConfiguration : IEntityTypeConfiguration<Factors>
    {
        public void Configure(EntityTypeBuilder<Factors> entity)
        {
            ...
            entity.Property(e => e.FactorDesc).HasMaxLength(500);
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<Factors> entity);
    }
}
